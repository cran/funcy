...
#define NONFATAL(msg_params...) (fl_print_msg( \
    __FILE__, "", __LINE__, FL_MSG_NONFATAL, msg_params))
...
#define NOTIFY_STAR(msg_params...) (fl_print_msg( \
    __FILE__, "", __LINE__, FL_MSG_NOTIFY_STAR, msg_params))
...
#define NOTIFY(msg_params...) (fl_print_msg( \
    __FILE__, "", __LINE__, FL_MSG_NOTIFY, msg_params))
